...
var TaskService = /** @class */ (function () {
    ...
    TaskService.prototype.create = function (createTaskDto) {
        ...
        return this.repository.save(__assign({ project: { id: createTaskDto.project_id }, section: { id: (_a = createTaskDto.section_id) !== null && _a !== void 0 ? _a : null } }, createTaskDto));
    };
    // findAll() {
    ...
    TaskService.prototype.update = function (id, updateTaskDto) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository.update(id, updateTaskDto)];
                    case 1:
                        task = _a.sent();
                        if (task.affected === 0)
