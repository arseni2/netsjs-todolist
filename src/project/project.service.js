...
var ProjectService = /** @class */ (function () {
    ...
    ProjectService.prototype.create = function (createProjectDto) {
    ...
    ProjectService.prototype.update = function (id, updateProjectDto) {
        return __awaiter(this, void 0, void 0, function () {
            var project;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository.update(id, updateProjectDto)];
                    case 1:
                        project = _a.sent();
                        if (project.affected === 0)
                            throw new common_1.NotFoundException('not found project');
                        return [2 /*return*/, this.repository.findOne(id, { relations: ['sections', 'tasks'] })];
                }
            });
        });
    };
