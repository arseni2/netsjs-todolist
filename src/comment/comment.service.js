...
var CommentService = /** @class */ (function () {
    ...
    CommentService.prototype.create = function (createCommentDto) {
        return this.repository.save(createCommentDto);
    };
    CommentService.prototype.update = function (id, updateCommentDto) {
        return __awaiter(this, void 0, void 0, function () {
            var comment;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository.update(id, updateCommentDto)];
                    case 1:
                        comment = _a.sent();
                        if (comment.affected === 0)
                            throw new common_1.NotFoundException('not found comment');
